...
public class RabbitMqConfig {
    ...
    @Value("${rabbitmq.company-queue3}")
    private String companyQueueName3;
    ...
    @Bean
    public Binding bindingCompany2(Queue companyQueue2, DirectExchange exchange) {
        return BindingBuilder.bind(companyQueue2).to(exchange).with(companyBindingKey2);
    }
    @Bean
    public Queue companyQueue3() {
        return new Queue(companyQueueName3);
    }

    @Bean
    public Binding bindingCompany3(Queue companyQueue3, DirectExchange exchange) {
        return BindingBuilder.bind(companyQueue3).to(exchange).with(companyBindingKey3);
    }
